...
| 개념 | 설명 | 적용 |
|------|------|------|
| [Self-Attention](/ko/docs/math/attention/self-attention) | 자기 자신 참조 | Transformer, ViT |
| [Cross-Attention](/ko/docs/math/attention/cross-attention) | 다른 시퀀스 참조 | VLM, Diffusion |
| [Positional Encoding](/ko/docs/math/attention/positional-encoding) | 위치 정보 주입 | 순서 인식 |
