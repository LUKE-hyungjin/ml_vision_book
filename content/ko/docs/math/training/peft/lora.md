...
- [QLoRA](/ko/docs/math/training/peft/qlora) - LoRA + 4bit 양자화
- [Adapter](/ko/docs/math/training/peft/adapter) - 레이어 삽입 방식
- [Prefix Tuning](/ko/docs/math/training/peft/prefix-tuning) - 프롬프트 학습
