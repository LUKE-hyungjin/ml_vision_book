...
{{% hint info %}}
**선수지식**: [DDPM](/ko/docs/components/generative/ddpm) | [VAE](/ko/docs/architecture/generative/vae) | [U-Net](/ko/docs/architecture/segmentation/unet)
{{% /hint %}}
...
- [Diffusion 수학](/ko/docs/components/generative/ddpm) - Diffusion 수학
