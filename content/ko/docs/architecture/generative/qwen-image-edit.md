...
{{% hint info %}}
**선수지식**: [Diffusion 기초](/ko/docs/math/diffusion/ddpm) | [VLM (Vision-Language Model)](/ko/docs/architecture/multimodal/vlm) | [Stable Diffusion](/ko/docs/architecture/generative/stable-diffusion)
{{% /hint %}}
