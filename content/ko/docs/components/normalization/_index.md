...
| 방법 | 정규화 축 | 주 사용처 |
|------|----------|----------|
| [Batch Norm](/ko/docs/components/normalization/batch-norm) | Batch | CNN |
| [Layer Norm](/ko/docs/components/normalization/layer-norm) | Feature | Transformer |
| [RMSNorm](/ko/docs/components/normalization/rms-norm) | Feature | LLM |
