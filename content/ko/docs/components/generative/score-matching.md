...
{{% hint info %}}
**선수지식**: [Gradient (미분)](/ko/docs/math/calculus) | [확률분포](/ko/docs/math/probability) | [DDPM](/ko/docs/components/generative/ddpm)
{{% /hint %}}
...
- [DDPM](/ko/docs/components/generative/ddpm) - 노이즈 예측 관점
